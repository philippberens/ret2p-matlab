%{
ret2p.GeneticLabels (imported) # List of datasets to analyze
...
classdef GeneticLabels < dj.Relvar & dj.AutoPopulate
    properties(Constant)
        table = dj.Table('ret2p.GeneticLabels');
        popRel = ret2p.Cells;
    end
    
    methods
        function self = GeneticLabels(varargin)
